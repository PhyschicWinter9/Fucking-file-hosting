    ...
    const handleFiles = useCallback(
        async (files: FileList | File[]) => {
            ...
            try {
                ...
                const completedFileIds = uploadStates.filter((state) => state.status === 'completed' && state.fileId).map((state) => state.fileId!);
                const completedFileData = uploadStates
                ...
                toast({
                    ...
                    description: `Successfully uploaded ${completedFileIds.length} file(s)`,
                    variant: 'default',
                });
            } catch (error) {
        ...
        [disabled, isUploading, validateFiles, onUploadStart, onUploadError, toast, enableBulkMode, onUploadComplete],
    );
